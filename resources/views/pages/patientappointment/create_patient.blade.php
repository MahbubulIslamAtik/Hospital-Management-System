    ...
    <form class="form-horizontal" action="{{ route('appointments.store') }}" method="post">
      ...
      <div class="card-body">
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" name="txtName" id="txtName" placeholder="Enter Your Full Name">
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" name="txtAge" id="txtAge" placeholder="Enter Your Email Address">
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" name="txtProblem" id="txtProblem" placeholder="Enter Your Phone Number">
          </div>
        </div>
        <div class="form-group row">
