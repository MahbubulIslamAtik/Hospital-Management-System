...
<section class="content">
  <div class="card">
    ...
    <form class="form-horizontal" action="{{ route('prescriptiondetails.update', $prescriptdetail->id) }}" method="post">
      @method("PUT");
      @csrf
      ...
      <div class="card-body">
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" value="{{$prescriptdetail->medicine}}" name="txtMedicine" id="txtMedicine" placeholder="Enter Your Email Address">
          </div>
        </div>
        <div class="form-group row">
          <label for="txtDose" class="col-sm-2 col-form-label">Dose</label>
          <div class="col-sm-10">
            <input type="text" class="form-control"  value="{{$prescriptdetail->dose}}" name="txtDose" id="txtDose" placeholder="Enter Dose Details">
          </div>
        </div>
        <div class="form-group row">
