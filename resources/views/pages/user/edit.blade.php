      ...
      <div class="card-body">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            ...
            <input type="text" class="form-control" name="txtUsername" id="txtUsername" value="{{ $user->username }}" placeholder="Enter Your Full Name">
          </div>
        </div>
        <div class="form-group row">
          <label for="txtPassword" class="col-sm-2 col-form-label">Password</label>
          <div class="col-sm-10">
            <input type="password" value="{{ $user->password }}" class="form-control" name="txtPassword" id="txtPassword" placeholder="Enter Your Course Name">
          </div>
        </div>
        <div class="form-group row">
